...
public class CitizenshipControllerIntegrationTest {
    ...
    @Test
    public void rightCountOfCitizenship() throws Exception {

        // Given:
        int countOfCitizenship = (int) citizenshipRepository.count();

        // When:
        ResultActions resultActions = mockMvc.perform(get("/citizenship/").contentType(MediaType.APPLICATION_JSON));
